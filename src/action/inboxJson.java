...
public class inboxJson extends ActionSupport {
	...
	public String execute() throws Exception{
		try {
		    ...
		    sql="select * from mail where mailstate=0 and account_mail="+account;
			...
			while(ret.next()) {
				c.add(new jsonmail(ret.getString(1),ret.getString(2),ret.getString(5)));			
