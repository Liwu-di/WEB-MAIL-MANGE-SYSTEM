...
public class caogaoJson extends ActionSupport {
	private static final long serialVersionUID=1L;
	private UserLogin user =new UserLogin(); 
	public ResultSet r;
	public  List<jsonmail> c;
	public String json;
	
	
	
	@JSON(name="CONTACT")
	public List getJsonmail() {
		return c;
	}
	public String execute() throws Exception{
		try {
			...
			c=new ArrayList<jsonmail>(); 
			
			//sql="select * from tongxun where account_tongxun="+account;
		    sql="select * from mail where mailstate=2 and account_mail="+account;
			...
			while(ret.next()) {
				c.add(new jsonmail(ret.getString(1),ret.getString(3),ret.getString(5)));			
