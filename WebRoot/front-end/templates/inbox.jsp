...
<body onload="sendRequest();">
	...
	<table height="850"  width="100%" border="0" cellpadding="0" cellspacing="0">
		
	  <tr >
	    <td width="17" height="29" valign="top" background="image/mail_leftbg.gif"><img src="image/left-top-right.gif" width="17" height="29" /></td>
	    <td width="935" height="29" valign="top" background="image/content-bg.gif">
	    	<table  width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
	      		<tr>
	        		<td height="31"><div class="titlebt">收件箱</div></td>
	      		</tr>
	    	</table>
	    </td>
	    <td width="16" valign="top" background="image/mail_rightbg.gif">
	    	<img src="image/nav-right-bg.gif" width="16" height="29" />
	    </td>
	  </tr>
	  <tr >
	    ...
	    <td  valign="top" bgcolor="#F7F8F9"><table width="100%" height="138" border="0" cellpadding="0" cellspacing="0">
	      ...
	      <tr >
	        <td  valign="top">
		        <div id="close">
		        	<table id="mail" width="98%" border="0" align="center" cellpadding="0" cellspacing="0" overflow="auto">
			          <tr>
			            <td class="left_txt">当前位置：收件箱</td>
			          </tr>
			          <tr>
			            <td height="20">
		            	...
		            	<td>
		            		<table width="100%" height="55" border="0" cellpadding="0" cellspacing="0">
		              			<tr>
		                			...
		                			<td width="90%" valign="top"><span class="left_txt2">在这里，您可以查看收到的邮件</span><span class="left_txt3"></span><span class="left_txt2">！</span><br>
		          ...
		          <tr>
		            <td>
		            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		              		...
		              		<tr>
		                		<td width="100%" height="30" align="left" bgcolor="#f2f2f2" class="left_txt2">已收邮件</td>
		          ...
		          <tr>
		            ...
		            <!--  --><td width="10%" bgcolor="#f2f2f2">&nbsp;&nbsp;&nbsp;寄件人</td>
		            <td width="32%" height="30" bgcolor="#f2f2f2">主题</td>
