...
<body>
	<h1>Reclaim Pass</h1>
		<div class="app-location">
			...
			<form method="POST">
                <div id="boder">
                <div class="forget"><label class="lab"><strong><span class="red">ACCOUNT</span></strong></label><input type="text" class="text" value="Account" name="account" id="reg00" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Account';}" ></div>
				<div class="forget"><label class="lab"><strong><span class="green">IDENTIFY</span></strong></label><input type="password" value="PASSWORD" name="id" id="reg01" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}"></div>
