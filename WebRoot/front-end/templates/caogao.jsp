        ...
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" height="55" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="90%" valign="top"><span class="left_txt2">在这里，您可以查看未发送的草稿</span><span class="left_txt3"></span><span class="left_txt2">！</span><br>
          ...
          <tr>
            <td><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="nowtable">
              <tr>
                <td class="left_bt2">&nbsp;&nbsp;&nbsp;&nbsp;草稿箱</td><td height="30"><button onclick="sendRequest();">刷新</button></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            ...
            <table id="mail" width="100%" border="0" cellspacing="0" cellpadding="0">
